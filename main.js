...
function drawScore1(context, score, boardDirection) {
...
function drawScore2(context, score, boardDirection) {
	var score = String(score);
	context.font = "80px Sans";
	context.fillStyle = "pink";
	var width = context.measureText(score).width;
...
function drawCenteredText1(context, text, y) {
...
function drawCenteredText2(context, text, y) {
	context.font = "100px Sans";
...
function render (dt) {
	...
	drawScore1(context, score1, BoardDirection.Left);
	drawScore2(context, score2, BoardDirection.Right);

	if (gameIsOver()) {
		drawCenteredText1(context, "Game Over", (boardHeight / 2));
		drawCenteredText2(context, "Press Enter to Retry", (boardHeight / 2) + 120);
	}
};
